...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate("/cars"); // Redirect sukses
        } catch (err) {
            // Ini akan menangkap error dari backend
        ...
        <div className="min-h-screen flex items-center justify-center bg-darkbg px-4">
            <div className="bg-cardbg p-8 rounded-2xl shadow-[0_0_30px_rgba(204,255,0,0.1)] border border-gray-800 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-neon text-black font-bold py-3 rounded-lg hover:bg-white hover:scale-[1.02] transition-all transform shadow-lg shadow-neon/20">
                        LOGIN
                    </button>
